...
def build_generator():
    model = models.Sequential([
        ...
        layers.Conv2DTranspose(1, 3, strides=1, padding='same', activation='tanh', use_bias=False)
    ])
    model.summary()
    return model

# -------------------------
# DCGAN Discriminator (Updated)
# -------------------------
...
def train_dcgan():
    ...
    for epoch in trange(EPOCHS):
        ...
        if epoch % 1000 == 0:
            ...
            print("Sample values from gen:", fake_imgs[0][0:3, 0:3, 0])
